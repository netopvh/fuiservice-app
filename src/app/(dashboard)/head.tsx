...
import { toggleSidebar, toggleTheme } from '@/redux/store/slices/themeConfig';
...
export default function Head() {
    ...
    const removeNotification = (value: number) => {
        setNotifications(notifications.filter((user: INotification) => user.id !== value));
    };
                                ...
                                <ul className="w-[300px] !py-0 text-xs text-dark dark:text-white-dark sm:w-[375px]">
                                    <li onClick={(e) => e.stopPropagation()}>
                                        <div className="flex items-center justify-between px-4 py-2 font-semibold">
                                            <h4 className="text-lg">Mensages</h4>
                                        </div>
                                    </li>
                                    {messages.length > 0 ? (
                                        <>
                                            ...
                                            <li className="mt-5 border-t border-white-light text-center dark:border-white/10">
                                                <button type="button" className="group !h-[48px] justify-center !py-4 font-semibold text-primary dark:text-gray-400">
                                                    <span className="group-hover:underline ltr:mr-1 rtl:ml-1 uppercase">Ver todas as mensagens</span>
                                                    <svg
                                ...
                                <ul className="w-[300px] divide-y !py-0 text-dark dark:divide-white/10 dark:text-white-dark sm:w-[350px]">
                                    <li onClick={(e) => e.stopPropagation()}>
                                        <div className="flex items-center justify-between px-4 py-2 font-semibold">
                                            ...
                                            {notifications.length ? <span className="badge bg-primary/80">{notifications.length} Novas</span> : ''}
                                        </div>
                                    </li>
                                    {notifications.length > 0 ? (
                                        <>
                                                        ...
                                                        <div className="group flex items-center px-4 py-2">
                                                            <div className="grid place-content-center rounded">
                                                                <div className="relative h-12 w-12">
                                                                    <img className="h-12 w-12 rounded-full object-cover" alt="profile" src={`/images/${notification.profile}`} />
                                                            ...
                                                            <div className="flex flex-auto ltr:pl-3 rtl:pr-3">
                                                                <div className="ltr:pr-3 rtl:pl-3">
                                                                    ...
                                                                    ></h6>
                                                                    <span className="block text-xs font-normal dark:text-gray-500">121</span>
                                                                </div>
                                                                <button
                                                                    type="button"
                                            ...
                                            <li>
                                                <div className="p-4">
                                                    <button className="btn btn-primary btn-small block w-full">Marcar como lido</button>
                                                </div>
                                            </li>
                                        </>
                                    ) : (
                            ...
                            >
                                <ul className="w-[230px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                                    ...
                                    <li className="border-t border-white-light dark:border-white-light/10">
                                        <Link href="#" onClick={handleLogout} className="!py-3 text-danger">
